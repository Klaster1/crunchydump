...
function downloadPage (page) {
	if (!page.locale || !page.locale.enUS) {
		var url = page.image_url
	} else {
		var url	= page.locale.enUS.encrypted_composed_image_url
	}

	return downloadImage(url)
	.catch(function() {
		return downloadImage(page.image_url)
	})
	.catch(function() {
		return downloadImage(page.locale.enUS.encrypted_composed_image_url)
	})
	.catch(function(err) {
