...
function APIClient (options) {
	this.host = options.host || 'http://api-manga.crunchyroll.com'
...
APIClient.prototype.listChapter = function getPages (options) {
	return this.callAPI('list_chapter', options)
}
